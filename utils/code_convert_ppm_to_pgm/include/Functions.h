...
// Calcule les histogrammes des composantes couleur d'une image passée en entrée
...
// Génère un kernel de flou gaussien selon la taille et le sigma passés en paramètres
...
// Applique un flou gaussien à l'image d'entrée, sur l'image de sortie
...
// Genere une sequence de 8 bits aléatoires
...
// Applique un flou selectif progressif à l'ensemble des pixels (on applique un XOR à chaque pixel de gauche à
// droite (dir == 0) ou de droite à gauche (dir == 1) et stocke les images respectives dans o_images
...
double computePSNR(ImageBase & image1, ImageBase & image2) {
    ...
    if (image1.getHeight() != image2.getHeight() || image1.getWidth() != image2.getWidth()) {
        printf("Les images ne sont pas de la même taille !\n");
        return -1;
    }
